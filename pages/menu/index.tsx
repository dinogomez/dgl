...
import { Table, Text, Dropdown, Loading, Grid, Spacer, Button, Col, Row, } from "@nextui-org/react"
...
const getTables = async() => {
  try{
    ...
    */
    ...
    <ModalCellEdit visible={visible} closeHandler={closeHandler} selectedRow={selectedRow} currentTable={selectedValue} />
